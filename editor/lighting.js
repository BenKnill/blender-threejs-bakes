export const LIGHTING_PRESETS = {
  golden_hour: {
    ...
    world: { type: "sky", strength: 0.8, color: [0.05, 0.055, 0.06], rotation_deg: 0 },
    exposure: 0.35,
  },
  noon: {
    label: "Noon",
...
export function currentLighting(elements) {
  ...
  return {
    ...
    sun: {
      ...
      elevation_deg: numericValue(elements.elevation, 10),
      color: hexToRgb(elements.sunColor.value, [1, 0.78, 0.48]),
      strength: numericValue(elements.sunStrength, 4),
      angle_deg: numericValue(elements.sunAngle, 1.8),
    },
    world: {
      type: elements.worldType.value || "sky",
      strength: numericValue(elements.worldStrength, 0.8),
      color: hexToRgb(elements.worldColor.value, [0.05, 0.055, 0.06]),
      rotation_deg: 0,
    },
